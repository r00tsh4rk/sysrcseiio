        ...
        <div class="navbar navbar-inverse navbar-fixed-top" role="banner">
            <div class="container">
                ...
                <li class="scroll"><a href="<?php echo base_url(); ?>PanelRegistro">Regresar al panel inicial   </a></li>
                 <li class="scroll"><a href="<?php echo base_url(); ?>Talleres">Ir a Talleres</a></li>
                 <li class="scroll"><a href="<?php echo base_url(); ?>VerRegistros">Ver Ficha de Registro</a></li>
                   <li class="scroll"><a href="<?php echo base_url(); ?>CursosB">Cursos B</a></li>
                    <li class="dropdown">
...
<section id="acerca-de">
    <div class="container">
      <div class="text-center">
        ...
        <h2 class="title-one">Panel de Cursos A</h2>
        <p>Panel que contiene todos cursos de los horarios A que se impartirán el Congreso de Actualización Docente CSEIIO-CIIDIR 2017, recuerda que solo puedes inscribirte a dos cursos.</p> 
      </div>
        ...
        <table id="tabla" class="table table-responsive table-bordered table-hover">
            ...
            <tbody style="background-color:#e6e6e6">
              ...
              <tr>
                ...
                <?php if($row->cupo <= 0) {
                  ?>
                  <button type="button" onclick="mostrarModal('<?php echo $row->id_curso; ?>','<?php echo $row->cupo; ?>');"  class="form-control btn btn-success" disabled>
                ...
                <button type="button" onclick="mostrarModal('<?php echo $row->id_curso; ?>','<?php echo $row->cupo; ?>','<?php echo $row->clave_curso; ?>','<?php echo $row->grupo; ?>');"  class="form-control btn btn-success" >
                    <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Inscribirse 
                  </button>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form role="form" method="POST" name="frmInscripcion" action="<?php echo base_url();  ?>ValidacionRegistroCursos">
            <div class="col-lg-12">
              <br>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <div style="text-align: center; font-size: xx-large;" class="alert alert-warning"><strong>Para la inscripción a cursos, cada asesor deberá elegir un curso de horario A y un curso en horario B, estos cursos deben ser diferentes.</strong></div>
