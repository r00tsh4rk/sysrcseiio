        ...
        <div class="navbar navbar-inverse navbar-fixed-top" role="banner">
            <div class="container">
                ...
                <li class="scroll"><a href="<?php echo base_url(); ?>CursosA">Ir a Cursos</a></li>
                    ...
                    <li class="scroll"><a href="<?php echo base_url(); ?>Talleres">Talleres A</a></li>
                    <li class="dropdown">
...
<section id="acerca-de">
    <div class="container">
      <div class="text-center">
        ...
        <h2 class="title-one">Panel de Talleres B</h2>
       ...
       <div>
                ...
                $tieneTallerEnA = $this->session->flashdata('userInscritoEnA');
                $tallerMismoNombreDifGrupo = $this->session->flashdata('mismoCursoDifGrupo');
                ...
                <?php }
                 ...
                 ?>
                    <div class="alert alert-danger alert-dismissible" style="text-aling:center; color:#8c8c8c"  role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <strong>Opps!</strong> <?php echo $tieneTallerEnA  ?>
                </div>

                 <?php }
                    if ($tallerMismoNombreDifGrupo) {   
                  ?>
                    <div class="alert alert-danger alert-dismissible" style="text-aling:center; color:#8c8c8c"  role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <strong>Opps!</strong> <?php echo $tallerMismoNombreDifGrupo  ?>
                </div>
