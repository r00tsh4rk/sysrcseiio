        ...
        <div class="navbar navbar-inverse navbar-fixed-top" role="banner">
            <div class="container">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="scroll active"><a href="<?php echo base_url(); ?>TalleresAdmin">Talleres</a></li>
    ...
    <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form role="form" method="POST" name="frmAgregarTaller" action="<?php echo base_url();  ?>TalleresAdmin/agregarTaller">
            <div class="col-lg-12">
              <br>
   ...
   <div class="modal fade" id="modalActualizar" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form role="form" method="POST" name="frmEditarTaller" action="<?php echo base_url();  ?>TalleresAdmin/editarTaller">
            <div class="col-lg-12">
              <br>
