...
<section id="acerca-de">
    <div class="container">
        <div class="text-center">
            ...
            <h2 class="title-one">Panel de Registros a Cursos</h2>
            <p>Tabla que contiene todos los registros a los cursos para el Congreso de Actualización Docente CSEIIO-CIIDIR 2017</p> 
        </div>
        <table id="tabla" class="table table-responsive table-bordered table-hover">
            <thead style="background-color:#80d4ff; color:#8c8c8c; text-aling:center;">
              <tr>
              <th>Folio de Registro del Curso</th>
                <th>Usuario de Registro al Curso</th>
              ...
              <?php 
               ...
               ?>
              <tr>
                <td><?php echo $row->id_regcurso; ?></td>
   ...
   <div class="modal fade" id="modalExcel" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form role="form" method="POST" name="frmReportes" action="<?php echo base_url();  ?>ReportesRegCursos/generarExcel">
            <div class="col-lg-12">
              <br>
               ...
               if (count($cursos)) {
                foreach ($cursos as $list) {
                  echo "<option value='". $list->id_curso . "'>" . $list->nombre_curso. "</option>";
                }
              }
              echo "</select><br/>";
              ?>
