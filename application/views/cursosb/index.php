            ...
            <div class="container">
               ...
               <li class="scroll"><a href="<?php echo base_url(); ?>PanelRegistro">Regresar al panel inicial</a></li>
                 ...
                 <li class="scroll"><a href="<?php echo base_url(); ?>VerRegistros">Ver Ficha de Registro</a></li>
                   <li class="scroll"><a href="<?php echo base_url(); ?>CursosA">Cursos A</a></li>
                    <li class="dropdown">
...
<section id="acerca-de">
    <div class="container">
      <div class="text-center">
        ...
        <h2 class="title-one">Panel de Cursos B</h2>
        <p>Panel que contiene todos cursos de los horios A que se impartirán el Congreso de Actualización Docente CSEIIO-CIIDIR 2017, recuerda que solo puedes inscribirte a dos cursos.</p> 
      </div>
